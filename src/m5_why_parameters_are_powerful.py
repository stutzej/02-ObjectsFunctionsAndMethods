...
def main():
    ...
    # even_better_draw_circles(rg.Point(100, 50), 20, 10, 'cyan', 4)
    # even_better_draw_circles(rg.Point(-200, 0), 5, 8, 'red', 1)
    even_better_draw_circles(rg.Point(100, 50), 20, 15, 'cyan', 4)
    even_better_draw_circles(rg.Point(100, 50), 30, 10, 'red', 2)
...
def even_better_draw_circles(point, delta, circles, color, thickness):
